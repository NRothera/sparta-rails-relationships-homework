...
class NetworksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post networks_url, params: { network: { brand: @network.brand, price: @network.price } }
    end
  ...
  test "should update network" do
    patch network_url(@network), params: { network: { brand: @network.brand, price: @network.price } }
